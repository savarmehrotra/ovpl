...
2) The test cases are written and tested for CentOS OpenVZAdapter.
...
responsible in ADS for creation of virtual machine. A VM will be
...
is responsible in ADS for intilization of virtual machine.
