...
class TestAWSAdapter(unittest.TestCase):
	...
	# VM creation is part of setup since this is the fundamental requirement
        # of every test case.
    ...
    def test_create_vm(self):
        ...
        test_logger.debug("test_create_vm(): vm_ip : %s for the newly created VM" % vm_ip)
	...
	test_logger.debug("test_vm_mgr_running(): vm manager port : %s" % vm_mgr_port)
