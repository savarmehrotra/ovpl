  ...
  build_requirements: {
    platform: {
      ...
      installer: [
        ...
        "git clone https://bitbucket.org/deviprasad/data_structures.git",
        "wget -b -O output/log.txt --user=witcracker --password=secretpassword www.myhome.in/config_lab.py"
      ],
      build_steps: {
