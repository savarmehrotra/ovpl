...
from lab_action_script import LabActionScript
...
class LabActionRunner:
    ...
    For example, the 'build' action has five steps: configure, pre_build,
    build, post_build, status.  Each of these steps may require the execution
    of zero or more scripts.
